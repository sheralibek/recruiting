...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware('job-seeker')->group(function () {
        ...
        Route::post('update-resume/{id}', [\App\Http\Controllers\ResumeController::class, 'update']);
    ...
    Route::middleware('employer')->group(function () {
        ...
        Route::post('update-vacancy/{id}', [\App\Http\Controllers\VacancyController::class, 'update']);
